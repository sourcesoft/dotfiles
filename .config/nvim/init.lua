...
-- Set the characters to display for whitespace
vim.opt.listchars = { tab = '» ', trail = '·', nbsp = '␣' }

-- Set the tab width to 4 (instead of default 8 which is too big for Golang)
vim.opt.tabstop = 4
...
-- Scroll jump when pressing <C-u> or <C-d>
vim.opt.scroll = 5
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          vim.keymap.set('n', '<leader>r', require('telescope.builtin').lsp_references, { desc = 'Show References' })

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          vim.keymap.set('n', '<leader>i', require('telescope.builtin').lsp_implementations, { desc = 'Show Implementations' })
  ...
  for _, win in ipairs(windows) do
    ...
    if vim.api.nvim_win_is_valid(win) then
      ...
      if buf_name:match 'neo%-tree' or buf_name:match 'edgy://' or buf_name:match 'OUTLINE_' then
        -- Close the window (and the buffer with it)
