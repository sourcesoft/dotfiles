...
5. Install some cool binaries like [reattach-to-user-namespace](https://github.com/ChrisJohnsen/tmux-MacOSX-pasteboard), [`universal-ctags`](https://github.com/universal-ctags/ctags), [colorls](https://github.com/athityakumar/colorls), [The Silver Searcher](https://github.com/ggreer/the_silver_searcher)  (https://github.com/sharkdp/bat)[bat] (https://github.com/sharkdp/fd)[fd] (https://github.com/ogham/exa)[exa] and [delta](https://github.com/dandavison/delta)
